...
public class CachedInstancesComparisionDemo {
    ...
    public static void main(String[] args) {
        ...
        long1 = Long.parseLong("123");
        long2 = Long.parseLong("123");
        //OBS. return TRUE this time //results the same with long2 = 123L;
        System.out.println("long1 == long2 after using the value of 123 :: " + (long1 == long2));

        long1 = Long.parseLong("128");
        long2 = Long.parseLong("128");
        //OBS. return FALSE again as 128 is greater than the caching range(-128 to 127)
        System.out.println("long1 == long2 after using the value of 128 :: " + (long1 == long2));
